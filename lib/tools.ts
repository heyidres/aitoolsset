...
export const TOOLS: Tool[] = [
  { id: "chatgpt", name: "ChatGPT", domain: "chat.openai.com", cat: "chat", tags: ["Chat", "Writing"], desc: "The world's leading AI for writing, coding, brainstorming, and creative tasks. Trusted by millions globally.", saves: 6338, free: true, trending: false, featured: true, trendPct: null, link: "/ai-tool/chatgpt", verified: true, deal: null },
  { id: "midjourney", name: "Midjourney", domain: "midjourney.com", cat: "image", tags: ["Image"], desc: "Transform text descriptions into breathtaking imagery. The gold standard for AI art generation.", saves: 3887, free: false, trending: true, featured: true, trendPct: 184, link: "/ai-tool/midjourney", verified: true, deal: { label: "20% off annual", expires: "May 15" } },
  { id: "claude", name: "Claude", domain: "claude.ai", cat: "chat", tags: ["Chat", "Writing"], desc: "Anthropic's thoughtful AI for nuanced reasoning, long-context analysis, and safe, helpful responses.", saves: 2807, free: true, trending: false, featured: true, trendPct: null, link: "/ai-tool/claude", verified: true, deal: null },
  { id: "perplexity", name: "Perplexity", domain: "perplexity.ai", cat: "research", tags: ["Search", "Research"], desc: "AI-powered search engine that finds, summarizes, and cites trustworthy information in real time.", saves: 1317, free: true, trending: false, featured: true, trendPct: null, link: "/ai-tool/perplexity", verified: true, deal: { label: "3 months free Pro", expires: "May 31" } },
  { id: "cursor", name: "Cursor", domain: "cursor.sh", cat: "code", tags: ["Code"], desc: "The AI-first IDE. Write, debug, and refactor code with an AI that understands your entire codebase.", saves: 1289, free: true, trending: true, featured: true, trendPct: 121, link: "/ai-tool/cursor", verified: true, deal: null },
  { id: "runway", name: "Runway", domain: "runwayml.com", cat: "video", tags: ["Video"], desc: "Professional-grade AI video generation, editing, and visual effects for filmmakers and creators.", saves: 741, free: false, trending: false, featured: true, trendPct: null, link: "/ai-tool/runway", verified: false, deal: { label: "50% off first month", expires: "May 5" } },
  { id: "suno", name: "Suno", domain: "suno.ai", cat: "audio", tags: ["Audio", "Music"], desc: "Create full-length, radio-quality songs from a text prompt. Lyrics, melody, and mastering — all AI.", saves: 698, free: true, trending: true, featured: true, trendPct: 197, link: "/ai-tool/suno", verified: true, deal: null },
  { id: "elevenlabs", name: "ElevenLabs", domain: "elevenlabs.io", cat: "audio", tags: ["Voice", "Audio"], desc: "Ultra-realistic AI voice cloning and text-to-speech in 32 languages. Industry-leading voice AI.", saves: 612, free: true, trending: false, featured: true, trendPct: null, link: "/ai-tool/elevenlabs", verified: true, deal: { label: "30% off Starter plan", expires: "Jun 1" } },
  { id: "v0", name: "v0 by Vercel", domain: "v0.dev", cat: "code", tags: ["Code", "Design"], desc: "Generate production-ready React + Tailwind UI components from natural language descriptions.", saves: 589, free: true, trending: true, featured: false, trendPct: 156, link: "/ai-tool/v0", verified: false, deal: null },
  { id: "gemini", name: "Google Gemini", domain: "gemini.google.com", cat: "chat", tags: ["Chat", "Research"], desc: "Google's multimodal AI for reasoning across text, images, audio, video, and code simultaneously.", saves: 1177, free: true, trending: false, featured: false, trendPct: null, link: "/ai-tool/gemini", verified: true, deal: null },
  ...
  { id: "kling", name: "Kling AI 2.0", domain: "klingai.com", cat: "video", tags: ["Video"], desc: "High-fidelity video generation from images and text with physics-accurate motion and cinematic quality.", saves: 388, free: false, trending: true, featured: false, trendPct: 197, link: "/ai-tool/kling", verified: false, deal: null },
];
