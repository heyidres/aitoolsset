...
export const POPULAR_CATS: PopularCategory[] = [
  { name: "Writing & Editing", color: "#0052ff", emoji: "✍️", desc: "Generate, edit, and polish text — from blog posts to marketing copy to long-form fiction.", count: 312, trend: "+24", tools: ["chat.openai.com", "claude.ai", "notion.so", "grammarly.com", "jasper.ai"], slug: slugify("Writing & Editing") },
