/**
 * POST /api/admin/news — create a manual news_post.
 *
 * Used by /admin/news/new. The pipeline cron writes drafts through
 ...
 * 'published' through the same /api/admin/news/[id] PATCH that the
 * pipeline drafts use.
 */
