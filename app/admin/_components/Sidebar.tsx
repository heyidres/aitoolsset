    ...
    <aside className="adm-sidebar">
      ...
      <nav className="adm-sb-nav">
        <div className="adm-sb-group">
          ...
          {item("/admin", "Dashboard", Icon.Dashboard)}
          {item("/admin/submissions", "Submissions", Icon.Submissions, {
        ...
        <div className="adm-sb-group">
          ...
          {item("/admin/reviews", "Reviews", Icon.Reviews, {
            value: String(counts.reviews),
            alert: counts.reviews > 0,
          })}
          {item("/admin/users", "Users", Icon.Users)}
        </div>

        <div className="adm-sb-group">
          <div className="adm-sb-group-title">System</div>
          {item("/admin/analytics", "Analytics", Icon.Analytics)}
          {item("/admin/settings", "Settings", Icon.Settings)}
        </div>
      </nav>
