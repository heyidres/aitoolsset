...
RULES:
- Output ONLY valid JSON matching the EXACT shape of the input.
- Keep brand and product names in English (ChatGPT, OpenAI, API, SEO, etc.).
- Preserve HTML tags in introHtml (<p>, <strong>, <a>, <ul>, etc.) — translate the text content, not the markup.
