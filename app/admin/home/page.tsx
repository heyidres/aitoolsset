      ...
      <div className="adm-panel">
        <div className="adm-panel-body" style={{ padding: 48, textAlign: "center" }}>
          ...
          <div style={{ display: "inline-flex", gap: 10, flexWrap: "wrap", justifyContent: "center" }}>
            ...
            <Link href="/admin/home/new" className="adm-btn-sm ghost" style={{ padding: "10px 22px" }}>
              + Add manually
            </Link>
          </div>
  ...
  return (
    <div className="adm-panel">
      <div className="adm-panel-head" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <Link href="/admin/home/new" className="adm-btn-sm primary">+ New section</Link>
      </div>
          ...
          {rows.map((r) => (
            <tr key={r.id} style={{ opacity: r.enabled ? 1 : 0.55 }}>
              ...
              <td style={{ textAlign: "right" }}>
                <Link href={`/admin/home/${r.id}/edit`} className="adm-btn-sm ghost" style={{ marginRight: 6 }}>Edit</Link>
