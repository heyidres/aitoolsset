    ...
    return (
      <div className="adm-panel">
        <div className="adm-panel-body" style={{ padding: 48, textAlign: "center" }}>
          ...
          <Link href="/admin/authors/new" className="adm-btn-sm primary" style={{ padding: "10px 22px" }}>
  ...
  return (
    <div className="adm-panel">
      <div className="adm-panel-head" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <Link href="/admin/authors/new" className="adm-btn-sm primary">+ New author</Link>
      </div>
          ...
          {rows.map((a) => (
            <tr key={a.id}>
              ...
              <td style={{ textAlign: "right" }}>
                <Link href={`/admin/authors/${a.id}/edit`} className="adm-btn-sm ghost" style={{ marginRight: 6 }}>Edit</Link>
