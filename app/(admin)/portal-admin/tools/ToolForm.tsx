/**
 * Shared tool form — used by /portal-admin/tools/new and
 * /portal-admin/tools/[id]/edit.
 *
...
export function ToolForm({
  ...
  /**
   * CMS-managed categories from /portal-admin/categories. When empty
          ...
          <Section title="Basics">
            ...
            <Row>
              <Field
                ...
                hint={
                  usingFallback
                    ? "No CMS categories yet — showing default list. Add categories in /portal-admin/categories to manage your own."
        ...
        <div>
          ...
          >
            ...
            <div style={{ marginTop: 16, display: "flex", flexDirection: "column", gap: 8 }}>
              ...
              <Link href="/portal-admin/tools" className="adm-btn-sm ghost" style={{ width: "100%", padding: "10px 14px", justifyContent: "center", fontSize: 13 }}>
                Cancel
              </Link>
            </div>
 ...
 * (POSTs to /api/portal-admin/upload) or paste a URL directly.
  ...
  if (allCategories.length === 0) {
    return (
      <div style={{ fontSize: 12, color: "var(--text-3)" }}>
        No categories available. Add some at /portal-admin/categories first.
      </div>
    );
  }
