 ...
 * exists (middleware lets /portal-admin/2fa through). Two modes:
 *
...
export default async function TwoFactorPage({
  ...
  const callbackUrl =
    sp.callbackUrl && sp.callbackUrl.startsWith("/portal-admin") && !sp.callbackUrl.startsWith("/portal-admin/login")
      ? sp.callbackUrl
      : "/portal-admin";
    ...
    return (
      <main className="al-shell">
        <div className="al-card">
          ...
          <p className="al-desc">Open your authenticator app and enter the current 6-digit code, or use a backup code.</p>
          <VerifyForm callbackUrl={callbackUrl} accountEmail={session.user.email ?? ""} />
        </div>
      </main>
    );
  }
