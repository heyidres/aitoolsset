...
export function BlogForm({
  ...
  /** CMS authors from /portal-admin/authors. Drives the multi-author picker + reviewed-by select. */
        ...
        <div>
          <div style={{ position: "sticky", top: 90, border: "1px solid var(--border)", borderRadius: 12, padding: 18, background: "var(--bg)" }}>
            ...
            <div style={{ marginTop: 16, display: "flex", flexDirection: "column", gap: 8 }}>
              ...
              <Link href="/portal-admin/blog" className="adm-btn-sm ghost" style={{ width: "100%", padding: "10px 14px", justifyContent: "center", fontSize: 13 }}>Cancel</Link>
            </div>
  ...
  if (allAuthors.length === 0) {
    return (
      <div style={{ fontSize: 12, color: "var(--text-3)" }}>
        No authors yet. <Link href="/portal-admin/authors/new" style={{ color: "var(--blue)" }}>Add an author</Link> to attribute this post.
      </div>
    );
  }
