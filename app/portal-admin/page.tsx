/**
 * Admin dashboard — landing page at /portal-admin.
 *
        ...
        <div>
          ...
          <div className="adm-panel">
            <div className="adm-panel-head">
              ...
              <Link href="/portal-admin/submissions" className="adm-btn-sm ghost">
                View all →
              </Link>
            </div>
                    ...
                    {recentSubs.map((s) => {
                      ...
                      return (
                        <tr key={s.id}>
                          ...
                          <td>
                            <Link href="/portal-admin/submissions" className="adm-btn-sm primary">
                              Review
                            </Link>
                          </td>
                        </tr>
            ...
            <div className="adm-panel-body flush">
              {topTools.length === 0 ? (
                <div style={{ padding: 24, textAlign: "center", color: "var(--text-3)", fontSize: 13 }}>
                  No tools yet —{" "}
                  <Link href="/portal-admin/tools/new" style={{ color: "var(--blue)", fontWeight: 700 }}>
                    add one
                  </Link>
                </div>
              ) : (
