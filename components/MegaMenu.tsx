    ...
    cols: [
      {
        ...
        items: [
          ...
          { title: "Top Rated", desc: "Highest-reviewed by users", href: "/ai-tools", icon: Icon.star },
          { title: "New Arrivals", desc: "Just added this week", href: "/ai-tools", icon: Icon.up, badge: "new" },
        ],
      },
      {
        title: "Popular Categories",
        links: [
          { label: "Marketing", href: "/ai-tools/marketing", count: "108" },
          { label: "Writing & Editing", href: "/ai-tools/essay-writing", count: "312" },
          { label: "Image Generation", href: "/ai-tools/image-generators", count: "218" },
          { label: "Code & Developer", href: "/ai-tools/ai-coding", count: "187" },
          { label: "Video & Animation", href: "/ai-tools/video-generators", count: "142" },
          { label: "Audio & Music", href: "/ai-tools/generating-ai-music", count: "96" },
        ],
      },
      {
        title: "By Pricing",
  ...
  },
  {
    ...
    cols: [
      ...
      },
      {
        title: "By Role",
        links: [
          { label: "For Writers", href: "/ai-tools/essay-writing" },
          { label: "For Developers", href: "/ai-tools/ai-coding" },
          { label: "For Marketers", href: "/ai-tools/marketing" },
          { label: "For Founders", href: "/ai-tools/startup-assistant" },
          { label: "For Designers", href: "/ai-tools/design-generators" },
        ],
      },
    ],
    feature: {
